...
📱 Os dados serão sincronizados automaticamente em todos os dispositivos em até 30 segundos.`,
  ...
  const mockSalesData = [
    { productName: "Rel�gio Personalizado", quantity: 2, totalPrice: 19.8, date: "2024-01-15" },
    ...
    { productName: "Rel�gio Personalizado", quantity: 3, totalPrice: 29.7, date: "2024-01-18" },
  ]
